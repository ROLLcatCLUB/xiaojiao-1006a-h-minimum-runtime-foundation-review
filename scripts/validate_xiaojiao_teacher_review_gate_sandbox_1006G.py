...
STAGE='1006G_TEACHER_REVIEW_GATE_SANDBOX'
FINAL='XIAOJIAO_TEACHER_REVIEW_GATE_SANDBOX_PASS'
SLUG='xiaojiao_teacher_review_gate_sandbox_1006G'
SAMPLE='teacher_review_gate_fixture_1006G.json'
MARKER='ALL_1006G_TEACHER_REVIEW_GATE_SANDBOX_CHECKS_OK'
