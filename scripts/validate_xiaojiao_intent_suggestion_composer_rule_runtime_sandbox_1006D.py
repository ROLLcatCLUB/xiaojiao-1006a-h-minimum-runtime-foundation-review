...
STAGE='1006D_INTENT_SUGGESTION_COMPOSER_RULE_RUNTIME_SANDBOX'
FINAL='XIAOJIAO_INTENT_SUGGESTION_COMPOSER_RULE_RUNTIME_SANDBOX_PASS'
SLUG='xiaojiao_intent_suggestion_composer_rule_runtime_sandbox_1006D'
SAMPLE='intent_suggestion_composer_rule_runtime_fixture_1006D.json'
MARKER='ALL_1006D_INTENT_SUGGESTION_COMPOSER_RULE_RUNTIME_SANDBOX_CHECKS_OK'
