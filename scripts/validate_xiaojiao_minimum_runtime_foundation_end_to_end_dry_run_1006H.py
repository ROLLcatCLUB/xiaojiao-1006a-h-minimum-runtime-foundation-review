...
STAGE='1006H_MINIMUM_RUNTIME_FOUNDATION_END_TO_END_DRY_RUN'
FINAL='XIAOJIAO_MINIMUM_RUNTIME_FOUNDATION_END_TO_END_DRY_RUN_PASS'
SLUG='xiaojiao_minimum_runtime_foundation_end_to_end_dry_run_1006H'
SAMPLE='minimum_runtime_foundation_e2e_dry_run_1006H.json'
MARKER='ALL_1006H_MINIMUM_RUNTIME_FOUNDATION_END_TO_END_DRY_RUN_CHECKS_OK'
