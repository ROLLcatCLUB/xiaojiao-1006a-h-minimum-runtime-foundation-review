...
STAGE='1006C_BUSINESS_PACK_AND_WORK_OBJECT_REGISTRY_SANDBOX'
FINAL='XIAOJIAO_BUSINESS_PACK_AND_WORK_OBJECT_REGISTRY_SANDBOX_PASS'
SLUG='xiaojiao_business_pack_and_work_object_registry_sandbox_1006C'
SAMPLE='business_pack_work_object_registry_fixture_1006C.json'
MARKER='ALL_1006C_BUSINESS_PACK_AND_WORK_OBJECT_REGISTRY_SANDBOX_CHECKS_OK'
