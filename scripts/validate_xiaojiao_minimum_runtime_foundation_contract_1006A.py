...
STAGE='1006A_MINIMUM_RUNTIME_FOUNDATION_CONTRACT'
FINAL='XIAOJIAO_MINIMUM_RUNTIME_FOUNDATION_CONTRACT_PASS'
SLUG='xiaojiao_minimum_runtime_foundation_contract_1006A'
SAMPLE='minimum_runtime_foundation_sample_1006A.json'
MARKER='ALL_1006A_MINIMUM_RUNTIME_FOUNDATION_CONTRACT_CHECKS_OK'
