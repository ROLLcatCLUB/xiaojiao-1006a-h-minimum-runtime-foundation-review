...
STAGE='1006E_RENDER_DIRECTIVE_TO_SURFACE_BINDING_SANDBOX'
FINAL='XIAOJIAO_RENDER_DIRECTIVE_TO_SURFACE_BINDING_SANDBOX_PASS'
SLUG='xiaojiao_render_directive_to_surface_binding_sandbox_1006E'
SAMPLE='render_directive_surface_binding_fixture_1006E.json'
MARKER='ALL_1006E_RENDER_DIRECTIVE_TO_SURFACE_BINDING_SANDBOX_CHECKS_OK'
