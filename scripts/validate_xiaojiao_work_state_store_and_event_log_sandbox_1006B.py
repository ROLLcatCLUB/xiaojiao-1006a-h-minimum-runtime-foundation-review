...
STAGE='1006B_WORK_STATE_STORE_AND_EVENT_LOG_SANDBOX'
FINAL='XIAOJIAO_WORK_STATE_STORE_AND_EVENT_LOG_SANDBOX_PASS'
SLUG='xiaojiao_work_state_store_and_event_log_sandbox_1006B'
SAMPLE='work_state_store_event_log_fixture_1006B.json'
MARKER='ALL_1006B_WORK_STATE_STORE_AND_EVENT_LOG_SANDBOX_CHECKS_OK'
